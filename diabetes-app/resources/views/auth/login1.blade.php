		...
		<div class="absolute top-0 w-full h-full bg-gray-900" style="background-image: url(./assets/img/register_bg_2.png);background-size: 100%; background-repeat: no-repeat;"></div>
            <div class="container mx-auto px-4 h-full">
					...
					<div class="w-full lg:w-4/12 px-4">
						...
						<div class="flex-auto px-4 lg:px-10 py-10 pt-0">
							<div class="text-gray-500 text-center mb-3 font-bold">
								<small>sign in with firebase</small>
							</div>
							<form method="POST" action="{{ route('loginbang') }}">
								@csrf
								<div class="relative w-full mb-3">
									<label class="block uppercase text-gray-700 text-xs font-bold mb-2"
									for="grid-password">Email</label><input type="email" required name="email"
				...
				" />
                                    ...
                                    <div class="relative w-full mb-3">
										<label class="block uppercase text-gray-700 text-xs font-bold mb-2"
										for="grid-password">Password</label><input type="password" required name="password"
										class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                    ...
                                    <div class="text-center mt-6">
										...
										<a href="{{ route("registerlur") }}">register</a>
                                    </div>
                                </form>
                            </div>
                        </div>
